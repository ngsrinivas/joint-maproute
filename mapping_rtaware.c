...
int prepare_objective_mn_rtaware(struct params_t p, double* beta, double* obj_coeff) {
...
int prepare_constraints_mn_rtaware(struct params_t p, double* beta, int* aptrb, int* aptre, int* asub, double* aval) {
...
int prepare_constbounds_mn_rtaware(struct params_t p, double* beta, MSKboundkeye* bkc, double* blc, double* buc) {
...
// Variable bounds
int prepare_varbounds_mn_rtaware(struct params_t p, MSKboundkeye* bkx, double* blx, double* bux) {
...
int setup_mapnode_rtaware(struct params_t p, struct msk_problem_t *mp, double* beta) {
  ...
  prepare_objective_mn_rtaware(p, beta, mp->obj_coeff);
  prepare_constraints_mn_rtaware(p, beta, mp->aptrb, mp->aptre, mp->asub, mp->aval);
  prepare_constbounds_mn_rtaware(p, beta, mp->bkc, mp->blc, mp->buc);
  prepare_varbounds_mn_rtaware(p, mp->bkx, mp->blx, mp->bux);
